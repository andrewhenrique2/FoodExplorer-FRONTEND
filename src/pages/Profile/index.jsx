                                    ...
                                    :
                                        ...
                                        <Infos>
                                            ...
                                            <Button
                                                ...
                                                icon={FiMail}
                                                onClick={() => window.location = 'emailfood@foodexplorer.com'}
                                            />

                                            <Button
                                                title="WhatsApp"
                                                icon={BsWhatsapp}
                                                onClick={() => window.open("https://api.whatsapp.com/send?phone=+999999999999&text=Olá! Gostaria de falar sobre o meu pedido!", '_blank')}
                                            />
                                        </Infos>
                                }
                            </div>
